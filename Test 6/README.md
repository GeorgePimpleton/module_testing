# C++20/23 Module Testing: Test 6 - formatting output
...
FYI, the pre-C++20 example uses the C library ::printf.  Using std::cout also works with I/O manipulators <iomanip>.  Though not as 'cleanly' as using ::printf.
